...
.. figure:: /images/editors/editors-properties-physics-physics.png
...
.. figure:: /images/editors/editors-properties-physics-collision_bounds.png
...
.. figure:: /images/editors/editors-properties-physics-rigid_body-bounding_box.png
...
Sphere
   Radius is defined by the object's scale (visible in the N properties panel) times the physics radius (can be found in :menuselection:`Physics --> Attributes --> Radius`). Note: This is the only bounds that respects the Radius option.
Cylinder
...
Convex Hull
   ...
   .. figure:: /images/editors/editors-properties-physics-rigid_body-convex_hull.png
      :width: 200px
...
By Hand
   ...
   .. figure:: /images/editors/editors-properties-physics-rigid_body-manual_hull.png
      :width: 300px
