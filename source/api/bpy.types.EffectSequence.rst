...
subclasses --- 
:class:`AddSequence`, :class:`AdjustmentSequence`, :class:`AlphaOverSequence`, :class:`AlphaUnderSequence`, :class:`ColorMixSequence`, :class:`ColorSequence`, :class:`CrossSequence`, :class:`GammaCrossSequence`, :class:`GaussianBlurSequence`, :class:`GlowSequence`, :class:`MulticamSequence`, :class:`MultiplySequence`, :class:`OverDropSequence`, :class:`SpeedControlSequence`, :class:`SubtractSequence`, :class:`TextSequence`, :class:`TransformSequence`, :class:`WipeSequence`
