...
.. function:: click_insert(frame=1.0, value=1.0, extend=False)
   ...
   :arg frame:
      ...
      Frame Number, Frame to insert keyframe on

   :type frame: float in [-inf, inf], (optional)
   :arg value:

      Value, Value for keyframe on
...
.. function:: clickselect(extend=False, column=False, curves=False)
   ...
   :arg curves:
      ...
      Only Curves, Select all the keyframes in the curve
...
.. function:: driver_variables_paste(replace=False)
   ...
   :arg replace:
      ...
      Replace Existing, Replace existing driver variables, instead of just appending to the end of the existing list
...
.. function:: duplicate_move(GRAPH_OT_duplicate=None, TRANSFORM_OT_transform=None)

   Make a copy of all selected keyframes and move them

   :arg GRAPH_OT_duplicate:

      Duplicate Keyframes, Make a copy of all selected keyframes

   :type GRAPH_OT_duplicate: :class:`GRAPH_OT_duplicate`, (optional)
...
.. function:: fmodifier_add(type='NULL', only_active=True)
   ...
   :arg only_active:
      ...
      Only Active, Only add F-Modifier to active F-Curve
...
.. function:: fmodifier_paste(only_active=True, replace=False)
   ...
   :arg only_active:
      ...
      Only Active, Only paste F-Modifiers on active F-Curve
...
.. function:: hide(unselected=False)
   ...
   :arg unselected:
      ...
      Unselected, Hide unselected rather than selected curves
...
.. function:: select_border(xmin=0, xmax=0, ymin=0, ymax=0, deselect=False, extend=True, axis_range=False, include_handles=False)
   ...
   :arg include_handles:
      ...
      Include Handles, Are handles tested individually against the selection criteria
...
.. function:: sound_bake(filepath="", filter_blender=False, filter_backup=False, filter_image=False, filter_movie=True, filter_python=False, filter_font=False, filter_sound=True, filter_text=False, filter_btx=False, filter_collada=False, filter_alembic=False, filter_folder=True, filter_blenlib=False, filemode=9, show_multiview=False, use_multiview=False, display_type='DEFAULT', sort_method='FILE_SORT_ALPHA', low=0.0, high=100000.0, attack=0.005, release=0.2, threshold=0.0, use_accumulate=False, use_additive=False, use_square=False, sthreshold=0.1)
   ...
   :arg use_additive:
      ...
      Additive, The amplitudes of the hull curve are summarized (or, when Accumulate is enabled, both positive and negative differences are accumulated)

   :type use_additive: boolean, (optional)
   :arg use_square:

      Square, The output is a square curve (negative values always result in -1, and positive ones in 1)

   :type use_square: boolean, (optional)
   :arg sthreshold:

      Square Threshold, Square only: all values with an absolute amplitude lower than that result in 0
...
.. function:: view_all(include_handles=True)
   ...
   :arg include_handles:
      ...
      Include Handles, Include handles of keyframes when calculating extents
