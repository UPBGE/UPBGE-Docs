...
.. function:: planar_faces(bm, faces, iterations, factor)
   ...
   :type faces: list of (:class:`bmesh.types.BMFace`)
   :arg iterations: Number of times to flatten faces (for when connected faces are used)
   :type iterations: int
   :arg factor: Influence for making planar each iteration
   :type factor: float
   :return:
...
.. function:: reverse_faces(bm, faces, flip_multires)
   ...
   :type faces: list of (:class:`bmesh.types.BMFace`)
   :arg flip_multires: maintain multi-res offset
...
.. function:: pointmerge(bm, verts, merge_co)
   ...
   :arg bm: The bmesh to operate on.
   :type bm: :class:`bmesh.types.BMesh`
   :arg verts: input vertices (all verts will be merged into the first).
   :type verts: list of (:class:`bmesh.types.BMVert`)
   :arg merge_co: Position to merge at.
...
.. function:: extrude_face_region(bm, geom, edges_exclude, use_keep_orig, use_select_history)
   ...
   :arg use_keep_orig: keep original geometry (requires ``geom`` to include edges).
...
.. function:: create_monkey(bm, matrix, calc_uvs)
...
.. function:: create_circle(bm, cap_ends, cap_tris, segments, radius, matrix, calc_uvs)
...
.. function:: wireframe(bm, faces, thickness, offset, use_replace, use_boundary, use_even_offset, use_crease, crease_weight, use_relative_offset, material_offset)
